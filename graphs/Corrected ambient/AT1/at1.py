...
ax.set_xlim([0,18])
ax.set_ylim([0,80])
plt.plot(z['Stud1_Axial'],z['Load in kN'], label="Stud1-Axial", color='red', markevery=(15,25), ms=4, marker='o')
...
plt.gcf()
plt.savefig('AT1-Load-Axial-Corrected.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('AT1-Load-Lateral-Corrected.pdf', bbox_inches='tight')
plt.show()
