...
t10 = pd.read_csv('t10-experiment.csv')
...
plt.gcf()
plt.savefig('T10-Furnace-ap.pdf', bbox_inches='tight')
plt.show()
...
# plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
# plt.gcf()
# plt.savefig('T10-Average-Pb-ap.pdf', bbox_inches='tight')
# plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Pb1-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Pb1-Pb2-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Pb2-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Pb3-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Pb3-Pb4-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Pb4-ap.pdf', bbox_inches='tight')
plt.show()
...
# plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
# plt.gcf()
# plt.savefig('T10-Stud2-Top-Amb-ap.pdf', bbox_inches='tight')
# plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Stud2-Mid-ap.pdf', bbox_inches='tight')
plt.show()
...
# plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
# plt.gcf()
# plt.savefig('T10-Stud2-Bottom-Amb-ap.pdf', bbox_inches='tight')
# plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Stud3-Top-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Stud3-Mid-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Stud3-Bottom-ap.pdf', bbox_inches='tight')
plt.show()
...
# plt.plot(t10['Time in Minutes'],t10['Stud4-Top-Amb-HF'], label='T10-Stud4-Top-Amb-HF', color='C1', markevery=1000, ms=4, marker='s')
# plt.plot(t10['Time in Minutes'],t10['Stud4-Top-Amb-CF'], label='T10-Stud4-Top-Amb-CF', color='C1', markevery=1000, ms=4, marker='d')
#plt.title('T10-Stud4-Top')
plt.xlabel('Time (min)', fontsize=14)
plt.ylabel('Temperature (°C)', fontsize=14)
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Stud4-Top-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Stud4-Mid-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Stud4-Bottom-ap.pdf', bbox_inches='tight')
plt.show()
...
# plt.plot(t10['Time in Minutes'],t10['Stud5-Mid-Amb-HF'], label='T10-Stud5-Mid-Amb-HF', color='C1', markevery=1000, ms=4, marker='s')
# plt.plot(t10['Time in Minutes'],t10['Stud5-Mid-Amb-CF'], label='T10-Stud5-Mid-Amb-CF', color='C2', markevery=1000, ms=4, marker='d')
#plt.title('T10-Stud5-Mid')
plt.xlabel('Time (min)', fontsize=14)
plt.ylabel('Temperature (°C)', fontsize=14)
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Stud5-Mid-ap.pdf', bbox_inches='tight')
plt.show()
...
ax.xaxis.label.set_size(12)
ax.yaxis.label.set_size(12)
plt.plot(t10['Time in Minutes'],t10['Stud2-Axial'], label='T10-Stud3-Axial', color='red', markevery=1000, ms=4, marker='o')
...
plt.plot(t10['Time in Minutes'],t10['Stud5-Axial'], label='T10-Stud3-Axial', color='C2', markevery=1000, ms=4, marker='d')
#plt.title('T10-Time vs Axial Displacement')
plt.xlabel('Time (min)', fontsize=14)
plt.ylabel('Axial Displacement (mm)', fontsize=14)
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Axial-ap.pdf', bbox_inches='tight')
plt.show()
...
ax.xaxis.label.set_size(12)
ax.yaxis.label.set_size(12)
plt.plot(t10['Time in Minutes'],t10['Stud3-Top'], label='T10-Stud3-Top', color='C0', markevery=1000, ms=4, marker='o')
plt.plot(t10['Time in Minutes'],t10['Stud3-Mid'], label='T10-Stud3-Mid', color='C1', markevery=1000, ms=4, marker='v')
plt.plot(t10['Time in Minutes'],t10['Stud3-Bottom'], label='T10-Stud3-Bottom', color='C2', markevery=1000, ms=4, marker='s')
# plt.plot(t10['Time in Minutes'],t10['Stud4-Top'], label='T10-Stud4-Top', color='C4', markevery=1000, ms=4, marker='x')
# plt.plot(t10['Time in Minutes'],t10['Stud4-Mid'], label='T10-Stud4-Mid', color='C6', markevery=1000, ms=4, marker='p')
# plt.plot(t10['Time in Minutes'],t10['Stud4-Bottom'], label='T10-Stud4-Bottom', color='C7', markevery=1000, ms=4, marker='')
#plt.title('T10-Time vs Lateral Displacement')
plt.xlabel('Time (min)', fontsize=14)
plt.ylabel('Lateral Deflection (mm)', fontsize=14)
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Lateral-ap.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T10-Load-ap.pdf', bbox_inches='tight')
plt.show()