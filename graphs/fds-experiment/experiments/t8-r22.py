...
#df = pd.read_csv('r22_devc.csv',header=1)
#df.insert(1, 'Time in Minutes',df['Time']/60)
#df.to_csv('r22_devc.csv', sep=',')

r22 = pd.read_csv('t8-r22_devc.csv')
ax = plt.axes()     
...
plt.plot(r22['Time in Minutes'],r22['Pb1'], label='Fds-T8-Pb1', color='red', linestyle='--', markevery=50, ms=4, marker='<')
plt.plot(r22['Time in Minutes'],r22['Pb1-Pb2'], label='Fds-T8-Pb1-Pb2', color='C0', linestyle='--', markevery=50, ms=4, marker='>')
plt.plot(r22['Time in Minutes'],r22['Pb2'], label='Fds-T8-Pb2', color='C1', linestyle='--', markevery=50, ms=4, marker='^')
plt.plot(r22['Time in Minutes'],r22['Pb3-Fire'], label='Fds-T8-Pb3-Fire', color='C2', linestyle='--', markevery=50, ms=4, marker='H')
plt.plot(r22['Time in Minutes'],r22['Pb3-Amb'], label='Fds-T8-Pb3-Amb', color='C3', linestyle='--', markevery=50, ms=4, marker='P')
plt.plot(r22['Time in Minutes'],r22['Pb4'], label='Fds-T8-Pb4', color='C4', linestyle='--', markevery=50, ms=4, marker='D')
plt.plot(r22['Time in Minutes'],r22['Pb4-Pb5'], label='Fds-T8-Pb4-Pb5', color='C5', linestyle='--', markevery=50, ms=4, marker='|')
plt.plot(r22['Time in Minutes'],r22['Pb5'], label='Fds-T8-Pb5', color='C6', linestyle='--', markevery=50, ms=4, marker='8')
#plt.title('Test3-Exp vs Fds Pb-r22')
plt.xlabel('Time(min)')
plt.ylabel('Temperature(°C)')
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=3)
plt.gcf()
plt.savefig('T8-r22-Pb-Fds-vs-Exp.pdf', bbox_inches='tight')
plt.show()
...
plt.plot(r22['Time in Minutes'],r22['FHF'], label='Fds-T8-Fire-HF', color='red', linestyle='--', markevery=50, ms=4, marker='x')
plt.plot(r22['Time in Minutes'],r22['FCF'], label='Fds-T8-Fire-CF', color='C0', linestyle='--', markevery=50, ms=4, marker='p')
plt.plot(r22['Time in Minutes'],r22['AHF'], label='Fds-T8-Amb-HF', color='C1', linestyle='--', markevery=50, ms=4, marker='h')
plt.plot(r22['Time in Minutes'],r22['ACF'], label='Fds-T8-Amb-CF', color='C2', linestyle='--', markevery=50, ms=4, marker='*')
#plt.title('Test3-Exp vs Fds Stud3-r22')
plt.xlabel('Time(min)')
plt.ylabel('Temperature(°C)')
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T8-r22-Studs-3-Fds-vs-Exp.pdf', bbox_inches='tight')
plt.show()
...
plt.plot(r22['Time in Minutes'],r22['FCF'], label='Fds-T8-Fire-CF', color='C0', linestyle='--', markevery=50, ms=4, marker='p')
plt.plot(r22['Time in Minutes'],r22['AHF'], label='Fds-T8-Amb-HF', color='C1', linestyle='--', markevery=50, ms=4, marker='h')
plt.plot(r22['Time in Minutes'],r22['ACF-Extra2'], label='Fds-T8-Amb-CF', color='C2', linestyle='--', markevery=50, ms=4, marker='*')
#plt.title('Test3-Exp vs Fds Stud4-r22')
plt.xlabel('Time(min)')
plt.ylabel('Temperature(°C)')
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T8-r22-Studs-4-Fds-vs-Exp.pdf', bbox_inches='tight')
plt.show()