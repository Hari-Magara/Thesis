...
#df = pd.read_csv('t9-r2_devc.csv',header=1)
#df.insert(1, 'Time in Minutes',df['Time']/60)
#df.to_csv('t9-r2_devc.csv', sep=',')

r2 = pd.read_csv('t9-r2_devc.csv')
ax = plt.axes()     
...
plt.plot(r2['Time in Minutes'],r2['Pb2'], label='Fds-T9-Pb1', color='red', linestyle='--', markevery=50, ms=4, marker='*')
plt.plot(r2['Time in Minutes'],r2['Pb1-Pb2'], label='Fds-T9-Pb1-Pb2', color='C0', linestyle='--', markevery=50, ms=4, marker='+')
plt.plot(r2['Time in Minutes'],r2['Pb1'], label='Fds-T9-Pb2', color='C1', linestyle='--', markevery=50, ms=4, marker='P')
plt.plot(r2['Time in Minutes'],r2['Pb3'], label='Fds-T9-Pb3', color='C2', linestyle='--', markevery=50, ms=4, marker='H')
plt.plot(r2['Time in Minutes'],r2['Pb3-Pb4'], label='Fds-T9-Pb3-Pb4', color='C3', linestyle='--', markevery=50, ms=4, marker='<')
plt.plot(r2['Time in Minutes'],r2['Pb4'], label='Fds-T9-Pb4', color='C4', linestyle='--', markevery=50, ms=4, marker='D')
# plt.title('Test6-Exp vs Fds Pb-r2')
plt.xlabel('Time(min)')
plt.ylabel('Temperature(°C)')
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=3)
plt.gcf()
plt.savefig('T9-r2-Pb-Fds-vs-Exp.pdf', bbox_inches='tight')
plt.show()
...
plt.plot(r2['Time in Minutes'],r2['FHF'], label='Fds-T9-Fire-HF', color='red', linestyle='--', markevery=50, ms=4, marker='x')
plt.plot(r2['Time in Minutes'],r2['FCF'], label='Fds-T9-Fire-CF', color='C0', linestyle='--', markevery=50, ms=4, marker='p')
plt.plot(r2['Time in Minutes'],r2['AHF'], label='Fds-T9-Amb-HF', color='C1', linestyle='--', markevery=50, ms=4, marker='h')
plt.plot(r2['Time in Minutes'],r2['ACF'], label='Fds-T9-Amb-CF', color='C2', linestyle='--', markevery=50, ms=4, marker='*')
# plt.title('Test6-Exp vs Fds Stud3-r2')
plt.xlabel('Time(min)')
plt.ylabel('Temperature(°C)')
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T9-r2-Studs-3-Fds-vs-Exp.pdf', bbox_inches='tight')
plt.show()
...
plt.plot(r2['Time in Minutes'],r2['FCF'], label='Fds-T9-Fire-CF', color='C0', linestyle='--', markevery=50, ms=4, marker='p')
plt.plot(r2['Time in Minutes'],r2['AHF'], label='Fds-T9-Amb-HF', color='C1', linestyle='--', markevery=50, ms=4, marker='h')
plt.plot(r2['Time in Minutes'],r2['ACF-Extra2'], label='Fds-T9-Amb-CF', color='C2', linestyle='--', markevery=50, ms=4, marker='*')
# plt.title('Test6-Exp vs Fds Stud4-r2')
plt.xlabel('Time(min)')
plt.ylabel('Temperature(°C)')
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T9-r2-Studs-4-Fds-vs-Exp.pdf', bbox_inches='tight')
plt.show()