...
plt.plot(f['Displacement in mm'],f['Load in kN'], label="FEA", color='C4', markevery=10, ms=4, marker='*')
...
plt.gcf()
plt.savefig('AT3-Load-Axial-Exp-vs-FE.pdf', bbox_inches='tight')
plt.show(0)
...
# plt.legend(fontsize=16, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
# plt.gcf()
# plt.savefig('AT2-Load-Lateral.pdf', bbox_inches='tight')
# plt.show()
