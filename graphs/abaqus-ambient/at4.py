...
z = pd.read_csv('AT4-r1.csv')
f = pd.read_csv('AT4-fe.csv')
...
plt.gcf()
plt.savefig('AT4-Load-Axial-Exp-vs-FE.pdf', bbox_inches='tight')
plt.show()
...
# plt.legend(fontsize=16, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
# plt.gcf()
# plt.savefig('AT4-Load-Lateral.pdf', bbox_inches='tight')
# plt.show()
