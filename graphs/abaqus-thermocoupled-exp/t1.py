...
plt.gcf()
plt.savefig('T1-axial-FE-vs-Exp.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T1-lateral-FE-vs-Exp.pdf', bbox_inches='tight')
plt.show()
...
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('T1-load-FE-vs-Exp.pdf', bbox_inches='tight')
plt.show()
