...
z = pd.read_csv('70-095-measured-r2.csv')
...
plt.plot(50,0.44588, color='red', label="50 mm", marker='o')
plt.plot(300,0.60391, color='C0', label="300 mm", marker='o')
plt.plot(1000,0.30601, color='C1', label="1000 mm", marker='o')
plt.plot(3000,0.047187, color='C2', label="3000 mm", marker='o')
...
plt.gcf()
plt.savefig('70-095-signature.pdf', bbox_inches='tight')
plt.show()
