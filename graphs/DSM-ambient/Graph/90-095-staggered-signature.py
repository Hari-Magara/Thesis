...
z = pd.read_csv('90-095-staggered-measured-r2.csv')
...
plt.plot(40,0.6927, color='red', label="40 mm", marker='o')
plt.plot(200,0.63684, color='C0', label="200 mm", marker='o')
plt.plot(300,0.76105, color='C1', label="300 mm", marker='o')
plt.plot(1000,0.99659, color='C2', label="1000 mm", marker='o')
plt.plot(3000,0.44239, color='C4', label="3000 mm", marker='o')
...
plt.gcf()
plt.savefig('90-095-st-signature.pdf', bbox_inches='tight')
plt.show()
