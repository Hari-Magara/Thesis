...
z = pd.read_csv('90-095-measured-r2.csv')
...
plt.plot(70,0.22074, color='red', label="70 mm", marker='o')
plt.plot(303.92,0.308687977, color='C0', label="300 mm", marker='o')
plt.plot(500,0.48528, color='C1', label="500 mm", marker='o')
plt.plot(1000,0.43037, color='C2', label="1000 mm", marker='o')
plt.plot(3000,0.058241, color='C4', label="3000 mm", marker='o')
...
plt.gcf()
plt.savefig('90-095-signature.pdf', bbox_inches='tight')
plt.show()
