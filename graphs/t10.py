...
plt.plot(t10['Time in Minutes'],t10['Stud4-Top-Fire-HF'], label='T10-Stud4-Top-Fire-HF', color='red', markevery=1000, ms=4, marker='o', linestyle='--')
plt.plot(t10['Time in Minutes'],t10['Stud4-Top-Fire-CF'], label='T10-Stud4-Top-Fire-CF', color='C0', markevery=1000, ms=4, marker='v', linestyle='--')
plt.plot(t10['Time in Minutes'],t10['Stud2-Top-Amb-HF'], label='T10-Stud2-Top-Amb-HF', color='C1', markevery=1000, ms=4, marker='s', linestyle='--')
plt.plot(t10['Time in Minutes'],t10['Stud2-Top-Amb-CF'], label='T10-Stud2-Top-Amb-CF', color='C2', markevery=1000, ms=4, marker='d', linestyle='--')
...
plt.plot(t10['Time in Minutes'],t10['Stud3-Top'], label='T10-Stud3-Top', color='C3', markevery=1000, ms=4, marker='d')
plt.plot(t10['Time in Minutes'],t10['Stud3-Mid'], label='T10-Stud3-Mid', color='C4', markevery=1000, ms=4, marker='>')
plt.plot(t10['Time in Minutes'],t10['Stud3-Bottom'], label='T10-Stud3-Bottom', color='C5', markevery=1000, ms=4, marker='+')
