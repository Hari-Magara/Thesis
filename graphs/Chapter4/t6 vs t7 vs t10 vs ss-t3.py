...
plt.plot(t6['Time in Minutes'],t6['Average-Pb1-Pb2'], label='T6-Pb1-Pb2', color='C0',  markevery=10, ms=4, marker='x')
...
plt.plot(t6['Time in Minutes'],t6['Average-Pb3'], label='T6-Pb3', color='C2',  markevery=10, ms=4, marker='$y$')
...
plt.plot(t6['Time in Minutes'],t6['Average-Pb3-Pb4'], label='T6-Pb3-Pb4', color='C4',  markevery=10, ms=4, marker='<')
...
plt.plot(t6['Time in Minutes'],t6['Average-Pb4'], label='T6-Pb4', color='C6',  markevery=10, ms=4, marker='$N$')
...
plt.gcf()
plt.savefig('T6vsT7vsT10vsSS-T3-Avg-Pb.pdf', bbox_inches='tight')
plt.show()
...
plt.plot(t6['Time in Minutes'],t6['Stud3-Top-Fire-CF'], label='T6-Stud3-Top-Fire-CF', color='C0', markevery=5, ms=4, marker='x')
...
plt.plot(t6['Time in Minutes'],t6['Stud3-Top-Amb-HF'], label='T6-Stud3-Top-Amb-HF', color='C1', markevery=5, ms=4, marker='+')
...
plt.gcf()
plt.savefig('T6vsT7vsT10vsSS-T3-Studs.pdf', bbox_inches='tight')
plt.show()
