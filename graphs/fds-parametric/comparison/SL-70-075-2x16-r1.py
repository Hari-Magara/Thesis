...
r1 = pd.read_csv('SL-70-075-2x16-r0_devc.csv')

#df = pd.read_csv('SL-70-075-2x16-r0_devc.csv',header=1)
#df.insert(1, 'Time in Minutes',df['Time']/60)
#df.to_csv('SL-70-075-2x16-r0_devc.csv', sep=',')
...
#plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
#plt.gcf()
#plt.savefig('SL-70-075-2x16-r0-Studs.pdf', bbox_inches='tight')
#plt.show()
