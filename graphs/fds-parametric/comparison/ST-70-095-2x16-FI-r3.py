...
r3P = pd.read_csv('ST-70-095-2x16-FI-r3_devc-O.csv')
ax = plt.axes()     
...
plt.gcf()
plt.savefig('ST-70-095-2x16-FI-r3-PB.pdf', bbox_inches='tight')
plt.show()
...
plt.gcf()
plt.savefig('ST-70-095-2x16-FI-r3-Studs.pdf', bbox_inches='tight')
plt.show()
