...
z = pd.read_csv('DS-70-095-2x16-AI-r0_devc.csv')

#df = pd.read_csv('DS-70-095-2x16-AI-r0_devc.csv',header=1)
#df.insert(1, 'Time in Minutes',df['Time']/60)
#df.to_csv('DS-70-095-2x16-AI-r0_devc.csv', sep=',')

r1 = pd.read_csv('DS-70-095-2x16-AI-r0_devc.csv')
r1P = pd.read_csv('DS-70-095-2x16-AI-r1_devc-O.csv')
ax = plt.axes()     
...
plt.gcf()
plt.savefig('DS-70-095-2x16-AI-r1-PB.pdf', bbox_inches='tight')
plt.show()
...
plt.gcf()
plt.savefig('DS-70-095-2x16-AI-r1-Studs.pdf', bbox_inches='tight')
plt.show()
...
#plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
#plt.gcf()
#plt.savefig('DS-70-095-2x16-AI-r0-Studs.pdf', bbox_inches='tight')
#plt.show()
