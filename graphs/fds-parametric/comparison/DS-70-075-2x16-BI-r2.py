...
z = pd.read_csv('DS-70-075-2x16-BI-r0_devc.csv')

#df = pd.read_csv('DS-70-075-2x16-BI-r0_devc.csv',header=1)
#df.insert(1, 'Time in Minutes',df['Time']/60)
#df.to_csv('DS-70-075-2x16-BI-r0_devc.csv', sep=',')

r1 = pd.read_csv('DS-70-075-2x16-BI-r0_devc.csv')
...
plt.plot(r2P['Time in Minutes'],r2P['Pb1'], label='Fds-O-Pb1', color='red', markevery=30, ms=4, marker='o', linestyle='--')
plt.plot(r2P['Time in Minutes'],r2P['Pb1-Pb2'], label='Fds-O-Pb1-Pb2', color='C0', markevery=30, ms=4, marker='v', linestyle='--')
plt.plot(r2P['Time in Minutes'],r2P['Pb2'], label='Fds-O-Pb2', color='C1', markevery=30, ms=4, marker='s', linestyle='--')
...
plt.plot(r2P['Time in Minutes'],r2P['FHF-Extra2'], label='Fds-O-Fire-HF', color='red', markevery=30, ms=4, marker='o', linestyle='--')
plt.plot(r2P['Time in Minutes'],r2P['AHF'], label='Fds-O-Fire-CF', color='C0', markevery=30, ms=4, marker='v', linestyle='--')
plt.plot(r2P['Time in Minutes'],r2P['ACF'], label='Fds-O-Amb-HF', color='C1', markevery=30, ms=4, marker='s', linestyle='--')
plt.plot(r2P['Time in Minutes'],r2P['AHF-Extra'], label='Fds-O-Amb-CF', color='C2', markevery=30, ms=4, marker='d', linestyle='--')
...
#plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
#plt.gcf()
#plt.savefig('DS-70-075-2x16-BI-r0-Studs.pdf', bbox_inches='tight')
#plt.show()
