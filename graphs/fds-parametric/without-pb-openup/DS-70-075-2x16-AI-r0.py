...
z = pd.read_csv('DS-70-075-2x16-AI-r0_devc.csv')

#df = pd.read_csv('DS-70-075-2x16-AI-r0_devc.csv',header=1)
#df.insert(1, 'Time in Minutes',df['Time']/60)
#df.to_csv('DS-70-075-2x16-AI-r0_devc.csv', sep=',')

r1 = pd.read_csv('DS-70-075-2x16-AI-r0_devc.csv')
ax = plt.axes()     
...
plt.gcf()
plt.savefig('DS-70-075-2x16-AI-r0-PB.pdf', bbox_inches='tight')
plt.show()
...
plt.gcf()
plt.savefig('DS-70-075-2x16-AI-r0-Studs.pdf', bbox_inches='tight')
plt.show()
