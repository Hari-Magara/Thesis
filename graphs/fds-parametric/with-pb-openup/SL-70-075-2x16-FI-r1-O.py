...
z = pd.read_csv('SL-70-075-2x16-FI-r1_devc-O.csv')

#df = pd.read_csv('SL-70-075-2x16-FI-r1P_devc.csv',header=1)
#df.insert(1, 'Time in Minutes',df['Time']/60)
#df.to_csv('SL-70-075-2x16-FI-r1P_devc.csv', sep=',')

r1P = pd.read_csv('SL-70-075-2x16-FI-r1_devc-O.csv')
ax = plt.axes()     
...
#plt.title('Test8-Exp vs Fds Pb-r1P')
plt.xlabel('Time(min)', fontsize=14)
plt.ylabel('Temperature(°C)', fontsize=14)
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=3)
plt.gcf()
plt.savefig('SL-70-075-2x16-FI-r1P-PB.pdf', bbox_inches='tight')
plt.show()
...
#plt.title('Test8-Exp vs Fds Stud3-r1P')
plt.xlabel('Time(min)', fontsize=14)
plt.ylabel('Temperature(°C)', fontsize=14)
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('SL-70-075-2x16-FI-r1P-Studs.pdf', bbox_inches='tight')
plt.show()
...
#ax.yaxis.label.set_size(12)
#ax.set_xlim([0,250])
#plt.plot(r1P['Time in Minutes'],r1P['FHF'], label='Fds-O-Fire-HF', color='red', markevery=30, ms=4, marker='o')
#plt.plot(r1P['Time in Minutes'],r1P['FCF'], label='Fds-O-Fire-CF', color='C0', markevery=30, ms=4, marker='v')
#plt.plot(r1P['Time in Minutes'],r1P['AHF'], label='Fds-O-Amb-HF', color='C1', markevery=30, ms=4, marker='s')
#plt.plot(r1P['Time in Minutes'],r1P['ACF'], label='Fds-O-Amb-CF', color='C2', markevery=30, ms=4, marker='d')
##plt.title('Test8-Exp vs Fds Stud3-r1P')
#plt.xlabel('Time(min)')
