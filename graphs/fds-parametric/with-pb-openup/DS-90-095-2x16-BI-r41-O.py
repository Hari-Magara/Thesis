...
z = pd.read_csv('DS-90-095-2x16-BI-r41_devc-O.csv')

# df = pd.read_csv('DS-90-095-2x16-BI-r41_devc.csv',header=1)
# df.insert(1, 'Time in Minutes',df['Time']/60)
# df.to_csv('DS-90-095-2x16-BI-r41_devc.csv', sep=',')

r1P = pd.read_csv('DS-90-095-2x16-BI-r41_devc-O.csv')
ax = plt.axes()     
...
plt.gcf()
plt.savefig('DS-90-095-2x16-BI-r41-PB.pdf', bbox_inches='tight')
plt.show()
...
plt.gcf()
plt.savefig('DS-90-095-2x16-BI-r41-Studs.pdf', bbox_inches='tight')
plt.show()
