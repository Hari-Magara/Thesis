...
z = pd.read_csv('DS-90-095-2x16-r61_devc-O.csv')

#df = pd.read_csv('DS-90-095-2x16-r61_devc.csv',header=1)
#df.insert(1, 'Time in Minutes',df['Time']/60)
#df.to_csv('DS-90-095-2x16-r61_devc.csv', sep=',')

r1P = pd.read_csv('DS-90-095-2x16-r61_devc-O.csv')
ax = plt.axes()     
...
#plt.title('Test8-Exp vs Fds Pb-r1', linestyle='--')
plt.xlabel('Time(min)', fontsize=14)
plt.ylabel('Temperature(°C)', fontsize=14)
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=3)
plt.gcf()
plt.savefig('DS-90-095-2x16-r61-PB.pdf', bbox_inches='tight')
plt.show()
...
plt.gcf()
plt.savefig('DS-90-095-2x16-r61-Studs.pdf', bbox_inches='tight')
plt.show()
