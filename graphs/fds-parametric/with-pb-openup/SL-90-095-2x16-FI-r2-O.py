...
z = pd.read_csv('SL-90-095-2x16-FI-r2_devc-O.csv')

# df = pd.read_csv('SL-90-095-2x16-FI-r2_devc.csv',header=1)
# df.insert(1, 'Time in Minutes',df['Time']/60)
# df.to_csv('SL-90-095-2x16-FI-r2_devc.csv', sep=',')

r1P = pd.read_csv('SL-90-095-2x16-FI-r2_devc-O.csv')
ax = plt.axes()     
...
plt.plot(r1P['Time in Minutes'],r1P['Pb3-Fire'], label='Fds-Pb3-Fire', color='C7', markevery=30, ms=4, marker='d', linestyle='--')
plt.plot(r1P['Time in Minutes'],r1P['Pb3-Amb'], label='Fds-Pb3-Fire', color='C8', markevery=30, ms=4, marker='x', linestyle='--')
plt.plot(r1P['Time in Minutes'],r1P['Pb4'], label='Fds-Pb4', color='C2', markevery=30, ms=4, marker='p', linestyle='--')
plt.plot(r1P['Time in Minutes'],r1P['Pb4-Pb5'], label='Fds-Pb4-Pb5', color='C4', markevery=30, ms=4, marker='h', linestyle='--')
plt.plot(r1P['Time in Minutes'],r1P['Pb5'], label='Fds-Pb5', color='C6', markevery=30, ms=4, marker='*', linestyle='--')
#plt.title('Test8-Exp vs Fds Pb-r1')
plt.xlabel('Time(min)', fontsize=14)
plt.ylabel('Temperature(°C)', fontsize=14)
plt.legend(fontsize=14, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=3)
plt.gcf()
plt.savefig('SL-90-095-2x16-FI-r2-PB.pdf', bbox_inches='tight')
plt.show()
...
plt.gcf()
plt.savefig('SL-90-095-2x16-FI-r2-Studs.pdf', bbox_inches='tight')
plt.show()
