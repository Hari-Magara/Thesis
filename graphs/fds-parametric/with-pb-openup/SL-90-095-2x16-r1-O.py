...
z = pd.read_csv('SL-90-095-2x16-r1_devc-O.csv')

# df = pd.read_csv('SL-90-095-2x16-r1_devc.csv',header=1)
# df.insert(1, 'Time in Minutes',df['Time']/60)
# df.to_csv('SL-90-095-2x16-r1_devc.csv', sep=',')

r1P = pd.read_csv('SL-90-095-2x16-r1_devc-O.csv')
ax = plt.axes()     
...
plt.gcf()
plt.savefig('SL-90-095-2x16-r1-PB.pdf', bbox_inches='tight')
plt.show()
...
plt.gcf()
plt.savefig('SL-90-095-2x16-r1-Studs.pdf', bbox_inches='tight')
plt.show()
