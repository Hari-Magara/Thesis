...
plt.plot(z['Stud5_Axial'],z['Load in kN'], label="Stud5-Axial", color='C4', markevery=25, ms=4, marker='x')
plt.plot(z['Stud6_Axial'],z['Load in kN'], label="Stud6-Axial", color='C6', markevery=25, ms=4, marker='p')
#plt.title('AT3 - Load vs Axial Displacement')
plt.xlabel('Displacement(mm)')
plt.ylabel('Load(kN)')
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('AT3-Load-Axial.pdf', bbox_inches='tight')
plt.show()
...
ax.set_xlim([-10,10])
ax.set_ylim([0,50])
plt.plot(z['Stud3_Top'],z['Load in kN'], label="Stud3-Top", color='red', markevery=25, ms=4, marker='o')
plt.plot(z['Stud3_Mid'],z['Load in kN'], label="Stud3-Mid", color='C0', markevery=25, ms=4, marker='v')
plt.plot(z['Stud3_Bottom'],z['Load in kN'], label="Stud3-Bottom", color='C1', markevery=25, ms=4, marker='s')
plt.plot(z['Stud4_Top'],z['Load in kN'], label="Stud4-Top", color='C2', markevery=25, ms=4, marker='d')
plt.plot(z['Stud4_Mid'],z['Load in kN'], label="Stud4-Mid", color='C4', markevery=25, ms=4, marker='x')
plt.plot(z['Stud4_Bottom'],z['Load in kN'], label="Stud4-Bottom", color='C6', markevery=25, ms=4, marker='p')
#plt.title('AT3 - Load vs Lateral Deflection')
plt.xlabel('Displacement(mm)')
plt.ylabel('Load(kN)')
plt.legend(fontsize=12, loc=9, bbox_to_anchor=(0.5, -0.15), ncol=2)
plt.gcf()
plt.savefig('AT3-Load-Lateral.pdf', bbox_inches='tight')
plt.show()
